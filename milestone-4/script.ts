...
function generateResume() {
  if (
      ...
      <main>
        <div class="Box">
          <div class="Information">
            <div class="Pic">
              <img class="profile-img" src="${img}" alt="Img" height="100%" width="50%" />
    ...
    if (
      ...
      // Select the edit button and content-editable elements after rendering the resume
      const editBtnEle = document.getElementById("edit-btn");
      const editEle = document.querySelectorAll("[contenteditable]");

      editBtnEle.addEventListener("click", () => {
